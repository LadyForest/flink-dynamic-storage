...
public class DefaultFileFormat implements FileFormat {
    ...
    /** Create a {@link DefaultFileFormat} from format identifier and format options. */
    public static DefaultFileFormat fromIdentifier(
            ClassLoader classLoader, String formatIdentifier, ReadableConfig formatOptions) {
        return new DefaultFileFormat(classLoader, formatIdentifier, formatOptions);
    }

    /** Create a {@link DefaultFileFormat} from table options. */
    public static DefaultFileFormat fromTableOptions(
